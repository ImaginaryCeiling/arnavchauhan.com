                ...
                <article className="space-y-2 xl:grid xl:grid-cols-4 xl:items-baseline xl:space-y-0">
                  <div>
                    <dl>
                      ...
                      <dd className="text-sm font-medium leading-5 text-gray-500 dark:text-gray-400">
                  ...
                  <div className="space-y-3 xl:col-span-3">
                    ...
                    <div className="prose max-w-none text-sm leading-6 text-gray-500 dark:text-gray-400 sm:text-base">
                      {summary}
                    </div>
